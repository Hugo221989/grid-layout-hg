...
import { InjectionToken, ɵɵdirectiveInject, ElementRef, ɵɵdefineDirective, ɵɵProvidersFeature, ɵsetClassMetadata, Directive, ɵɵinject, NgZone, ɵɵdefineInjectable, Injectable, Renderer2, ɵɵdefineComponent, ɵɵcontentQuery, ɵɵqueryRefresh, ɵɵloadQuery, ɵɵstaticViewQuery, ɵɵprojectionDef, ɵɵprojection, ɵɵelement, Component, ChangeDetectionStrategy, Inject, ContentChildren, ViewChild, Input, EventEmitter, ɵɵNgOnChangesFeature, ViewEncapsulation, Output, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
...
KtdGridDragHandle.ɵfac = function KtdGridDragHandle_Factory(t) { return new (t || KtdGridDragHandle)(ɵɵdirectiveInject(ElementRef)); };
KtdGridDragHandle.ɵdir = ɵɵdefineDirective({ type: KtdGridDragHandle, selectors: [["", "ktdGridDragHandle", ""]], hostAttrs: [1, "ktd-grid-drag-handle"], features: [ɵɵProvidersFeature([{ provide: KTD_GRID_DRAG_HANDLE, useExisting: KtdGridDragHandle }])] });
/*@__PURE__*/ (function () { ɵsetClassMetadata(KtdGridDragHandle, [{
        type: Directive,
        args: [{
...
KtdGridResizeHandle.ɵfac = function KtdGridResizeHandle_Factory(t) { return new (t || KtdGridResizeHandle)(ɵɵdirectiveInject(ElementRef)); };
KtdGridResizeHandle.ɵdir = ɵɵdefineDirective({ type: KtdGridResizeHandle, selectors: [["", "ktdGridResizeHandle", ""]], hostAttrs: [1, "ktd-grid-resize-handle"], features: [ɵɵProvidersFeature([{ provide: KTD_GRID_RESIZE_HANDLE, useExisting: KtdGridResizeHandle }])] });
/*@__PURE__*/ (function () { ɵsetClassMetadata(KtdGridResizeHandle, [{
        type: Directive,
        args: [{
...
KtdGridService.ɵfac = function KtdGridService_Factory(t) { return new (t || KtdGridService)(ɵɵinject(NgZone)); };
KtdGridService.ɵprov = ɵɵdefineInjectable({ token: KtdGridService, factory: KtdGridService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { ɵsetClassMetadata(KtdGridService, [{
        type: Injectable,
...
KtdGridItemComponent.ɵfac = function KtdGridItemComponent_Factory(t) { return new (t || KtdGridItemComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(KtdGridService), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(GRID_ITEM_GET_RENDER_DATA_TOKEN)); };
KtdGridItemComponent.ɵcmp = ɵɵdefineComponent({ type: KtdGridItemComponent, selectors: [["ktd-grid-item"]], contentQueries: function KtdGridItemComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵɵcontentQuery(dirIndex, KTD_GRID_DRAG_HANDLE, true);
        ɵɵcontentQuery(dirIndex, KTD_GRID_RESIZE_HANDLE, true);
    } if (rf & 2) {
        let _t;
        ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._dragHandles = _t);
        ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._resizeHandles = _t);
    } }, viewQuery: function KtdGridItemComponent_Query(rf, ctx) { if (rf & 1) {
        ɵɵstaticViewQuery(_c0, true, ElementRef);
    } if (rf & 2) {
        let _t;
        ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.resizeElem = _t.first);
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(KtdGridItemComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ElementRef }, { type: KtdGridService }, { type: Renderer2 }, { type: NgZone }, { type: undefined, decorators: [{
                type: Inject,
...
KtdGridComponent.ɵfac = function KtdGridComponent_Factory(t) { return new (t || KtdGridComponent)(ɵɵdirectiveInject(KtdGridService), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone)); };
KtdGridComponent.ɵcmp = ɵɵdefineComponent({ type: KtdGridComponent, selectors: [["ktd-grid"]], contentQueries: function KtdGridComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵɵcontentQuery(dirIndex, KtdGridItemComponent, true);
    } if (rf & 2) {
        let _t;
        ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._gridItems = _t);
        ...
        ]), ɵɵNgOnChangesFeature], ngContentSelectors: _c0$1, decls: 1, vars: 0, template: function KtdGridComponent_Template(rf, ctx) { if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵprojection(0);
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(KtdGridComponent, [{
        type: Component,
        args: [{
                selector: 'ktd-grid',
    ...
    }], function () { return [{ type: KtdGridService }, { type: ElementRef }, { type: Renderer2 }, { type: NgZone }]; }, { _gridItems: [{
            type: ContentChildren,
...
KtdGridModule.ɵmod = ɵɵdefineNgModule({ type: KtdGridModule });
KtdGridModule.ɵinj = ɵɵdefineInjector({ factory: function KtdGridModule_Factory(t) { return new (t || KtdGridModule)(); }, providers: [
        KtdGridService
    ], imports: [[
            CommonModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(KtdGridModule, { declarations: [KtdGridComponent,
        ...
        KtdGridDragHandle,
        KtdGridResizeHandle] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(KtdGridModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    KtdGridComponent,
